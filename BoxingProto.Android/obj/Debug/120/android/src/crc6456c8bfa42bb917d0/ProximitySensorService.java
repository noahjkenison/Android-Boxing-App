...
public class ProximitySensorService
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BoxingProto.Droid.ProximitySensorService, BoxingProto.Android", ProximitySensorService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ProximitySensorService.class) {
			mono.android.TypeManager.Activate ("BoxingProto.Droid.ProximitySensorService, BoxingProto.Android", "", this, new java.lang.Object[] {  });
		}
	}
