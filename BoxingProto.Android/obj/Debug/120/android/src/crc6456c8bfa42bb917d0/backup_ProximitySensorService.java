package crc6456c8bfa42bb917d0;


public class backup_ProximitySensorService
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BoxingProto.Droid.backup+ProximitySensorService, BoxingProto.Android", backup_ProximitySensorService.class, __md_methods);
	}


	public backup_ProximitySensorService ()
	{
		super ();
		if (getClass () == backup_ProximitySensorService.class) {
			mono.android.TypeManager.Activate ("BoxingProto.Droid.backup+ProximitySensorService, BoxingProto.Android", "", this, new java.lang.Object[] {  });
		}
	}
